      ...
      <div className="resultsContainer" style={{
        backgroundColor: departure ? "white" : null
                ...
                <div
                    ...
                    style={{
                    backgroundColor:
                      lines === "Central" ? "#E32017": 
                      lines === "Bakerloo"? "#B36305": 
                      lines === "Metropolitan"? "#9B0056": 
                      lines === "Piccadilly"? "#003688": 
                      lines === "Northern"? "#000000": 
                      lines === "District"? "#00782A": 
                      lines === "Jubilee"? "#A0A5A9": 
                      lines === "Victoria"? "#0098D4": 
                      lines === "Circle"? "#FFD300": 
                      lines === "Elizabeth"? "#6950a1": 
                      lines === "Hammersmith & City"? "#F3A9BB": 
                      lines === "Waterloo & City"? "#95CDBA": 
                      lines === "Chiltern Railways"? "rgba(0, 0, 0, 0.5)": null}}
                    >
          ...
          <div className="journeyResults">
                ...
                <div className="middle">
                  ...
                  <div
                    className="lineImage"
                    style={{
                    borderColor:lines === "Central" ? "#E32017": lines === "Bakerloo"? "#B36305": lines === "Metropolitan"? "#9B0056": lines === "Piccadilly"? "#003688": lines === "Northern"? "#000000": lines === "District"? "#00782A": lines === "Jubilee"? "#A0A5A9": lines === "Victoria"? "#0098D4": lines === "Circle"? "#FFD300": lines === "Elizabeth"? "#6950a1": lines === "Hammersmith & City"? "#F3A9BB": lines === "Waterloo & City"? "#95CDBA": lines === "Chiltern Railways"? "rgba(0, 0, 0, 0.5)": null,
                    color:lines === "Central" ? "#E32017": lines === "Bakerloo"? "#B36305": lines === "Metropolitan"? "#9B0056": lines === "Piccadilly"? "#003688": lines === "Northern"? "#000000": lines === "District"? "#00782A": lines === "Jubilee"? "#A0A5A9": lines === "Victoria"? "#0098D4": lines === "Circle"? "#FFD300": lines === "Elizabeth"? "#6950a1": lines === "Hammersmith & City"? "#F3A9BB": lines === "Waterloo & City"? "#95CDBA": lines === "Chiltern Railways"? "rgba(0, 0, 0, 0.5)": null}}
                  >
                ...
                <div className="right">{journey.arrivalDateTime.slice(11,16)}</div>
                
              </div>

              <div className="bottom">{lines ? <span>£{fare}</span> : ""}</div>
